...
#CUDA_VISIBLE_DEVICES=4 taskset -c 41-50 python train.py --config induction.yaml --overrides model.ssm_type=S6-Real dataset.auto_regressive=True dataset.induction_len=1024 dataset.seq_len=2048&
#CUDA_VISIBLE_DEVICES=5 taskset -c 51-60 python train.py --config induction.yaml --overrides model.ssm_type=S6-Complex dataset.auto_regressive=True dataset.induction_len=1024 dataset.seq_len=2048&
